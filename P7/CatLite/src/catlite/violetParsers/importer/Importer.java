...
//								System.out.println("\t\t\t\tAdded Interface #" +curAddingFaceNum + ": " + classInterfaces.get(curAddingFaceNum));
                    ...
                    NodeList voidLabelNodes = firstObjElement.getElementsByTagName("void");
                    Element voidLabelElement = (Element) voidLabelNodes.item(0);
                    String label = getTagValue("string", voidLabelElement, 0);
                    ...
                    for (int k = 0; k < addNodeObjs.getLength(); k++) {
                        ...
                        if (!nextObjIdref.equals("")) {
                            if (!seenFromClass) {
                                ...
                                stateTransitions.get(curAddingEdgeNum).setLabel(label);
                            }
                        }
                    }
